...
export const words = ['liber', 'singol', 'camer', 'affitto'];
export const tabooWords = ['coinquilina', 'studentessa', 'disperat', 'ragazza', 'vendo', 'cerco'];
export const itemsToRemoveByClassName = [
...
export const itemsToRemoveById = [
  'MComposer',
  'MStoriesTray',
  // 'MChromeHeader'
];
